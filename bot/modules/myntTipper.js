...
exports.commands = ['tipmynt'];
exports.tipmynt = {
  usage: '<subcommand>',
  description:
    '__**Mynt (MYNT) Tipper**__\nTransaction Fees: **' + paytxfee + '**\n    **!tipmynt** : Displays This Message\n    **!tipmynt balance** : get your balance\n    **!tipmynt deposit** : get address for your deposits\n    **!tipmynt withdraw <ADDRESS> <AMOUNT>** : withdraw coins to specified address\n    **!tipmynt <@user> <amount>** :mention a user with @ and then the amount to tip them\n    **!tipmynt private <user> <amount>** : put private before Mentioning a user to tip them privately.\n\n    has a default txfee of ' + paytxfee,
...
function doBalance(message, tipper) {
  mynt.getBalance(tipper, 1, function(err, balance) {
    ...
    description: '**:bank::money_with_wings::moneybag:Mynt (MYNT) Balance!:moneybag::money_with_wings::bank:**',
    color: 1363892,
    fields: [
      {
        name: '__User__',
...
function doDeposit(message, tipper) {
  getAddress(tipper, function(err, address) {
    ...
    message.channel.send({ embed: {
    description: '**:bank::card_index::moneybag:Mynt (MYNT) Address!:moneybag::card_index::bank:**',
    color: 1363892,
    fields: [
      {
        name: '__User__',
  ...
  mynt.getBalance(tipper, 1, function(err, balance) {
    if (err) {
      ...
      mynt.sendFrom(tipper, address, Number(amount), function(err, txId) {
        ...
        message.channel.send({embed:{
        description: '**:outbox_tray::money_with_wings::moneybag:Mynt (MYNT) Transaction Completed!:moneybag::money_with_wings::outbox_tray:**',
        color: 1363892,
        fields: [
          {
            name: '__Sender__',
          ...
          mynt.sendFrom(tipper, address, Number(amount), 1, null, null, function(err, txId) {
              if (err) {
                ...
                if (privacyFlag) {
                  ...
                  description: '**:money_with_wings::moneybag:Mynt (MYNT) Transaction Completed!:moneybag::money_with_wings:**',
                  color: 1363892,
                  fields: [
                    {
                      name: '__Sender__',
                ...
                fields: [
                  ...
                  if (
                    message.content.startsWith('!tipmynt private ')
                  ) {
